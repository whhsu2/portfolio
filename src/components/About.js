...
const About = () => {
    return (
        <div className="about section"> 
            ...
            <div className="me">
                <p>I just graduated from Harvard Health Data Science program and currently am working at Aetna as a Software Engineer. Previously 
                I studied Nano Science at NCTU in Taiwan, mainly focusing on semiconductor fabrication.
                Since then, I have taken a huge pivot, now I am a software developer that focus on digitising the healthcare experience. 
                </p>
                <p>
